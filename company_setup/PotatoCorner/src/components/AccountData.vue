<template>
  <v-layout row wrap>
    <v-flex xs8>
      ...
      <v-layout row align-center>
        <v-flex xs4>
          <v-subheader>Date Approved</v-subheader>
        </v-flex>
        <v-flex xs8>
      ...
      <!-- <v-layout row>
        ...
        <v-flex xs8>
          <v-text-field v-model="accountData.firstName" disabled></v-text-field>
        </v-flex>
      </v-layout>
      ...
      <v-layout row>
        ...
        <v-flex xs8>
          <v-text-field v-model="accountData.middleInitial" disabled></v-text-field>
        </v-flex>
      </v-layout>
      ...
      <v-layout row>
        ...
        <v-flex xs8>
          <v-text-field v-model="accountData.lastName" disabled></v-text-field>
        </v-flex>
      </v-layout>
      ...
      <v-layout row>
        ...
        <v-flex xs8>
          <v-text-field v-model="accountData.birthday" :disabled="disableEdit"></v-text-field>
        </v-flex>
      </v-layout> -->
