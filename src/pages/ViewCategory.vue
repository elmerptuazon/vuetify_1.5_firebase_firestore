  ...
  methods: {
    ...
    async deleteProducts() {
      ...
      try {
        ...
        this.notify(
          "success",
          "All selected products has been successfully removed"
        );
      } catch (error) {
        console.log(error);
        this.notify("error", "An error occurred");
    ...
    async archiveProducts() {
      ...
      try {
        ...
        this.notify(
          "success",
          "All selected products has been successfully archived"
        );
      } catch (error) {
        console.error(e);
        this.notify("error", "An error occurred");
